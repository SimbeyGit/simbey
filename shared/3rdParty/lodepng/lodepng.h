...
#ifndef lodepng_size_t
    #include <string.h> /*for size_t*/
    #define lodepng_size_t  size_t
#endif
...
*/
/*deflate&zlib. If disabled, you need to define two zlib functions, see documentation of LODEPNG_CUSTOM_ZLIB_... below*/
...
--> you must then provide following function in your source files that LodePNG will link to:
  unsigned lodepng_custom_inflate(unsigned char**, lodepng_size_t*, const unsigned char*, lodepng_size_t,
                                  const LodePNGDecompressSettings*)
2: allow using custom deflate decoder with a setting
--> you must then provide following function in your source files that LodePNG will link to:
  unsigned lodepng_custom_zlib_decompress(unsigned char**, lodepng_size_t*, const unsigned char*, lodepng_size_t,
                                          const LodePNGDecompressSettings*)
*/
...
--> you must then provide following function in your source files that LodePNG will link to:
  unsigned lodepng_custom_deflate(unsigned char**, lodepng_size_t*, const unsigned char*, lodepng_size_t,
                                  const LodePNGCompressSettings*)
2: allow using custom deflate encoder with a setting
--> you must then provide following function in your source files that LodePNG will link to:
  unsigned lodepng_custom_zlib_compress(unsigned char**, lodepng_size_t*, const unsigned char*, lodepng_size_t,
                                        const LodePNGCompressSettings*)
*/
...
{
  LCT_GRAY = 0, /*grayscale: 1,2,4,8,16 bit*/
  LCT_RGB = 2, /*RGB: 8,16 bit*/
  LCT_PALETTE = 3, /*palette: 1,2,4,8 bit*/
  LCT_GRAY_ALPHA = 4, /*grayscale with alpha: 8,16 bit*/
...
Return value: LodePNG error code (0 means no error).
*/
unsigned lodepng_encode_memory(unsigned char** out, lodepng_size_t* outsize,
                               const unsigned char* image, unsigned w, unsigned h,
                               LodePNGColorType colortype, unsigned bitdepth,
							   bool fAutoSelectColor = true);

/*Same as lodepng_encode_memory, but always encodes from 32-bit RGBA raw image.*/
unsigned lodepng_encode32(unsigned char** out, lodepng_size_t* outsize,
                          const unsigned char* image, unsigned w, unsigned h,
						  bool fAutoSelectColor = true);

/*Same as lodepng_encode_memory, but always encodes from 24-bit RGB raw image.*/
unsigned lodepng_encode24(unsigned char** out, lodepng_size_t* outsize,
                          const unsigned char* image, unsigned w, unsigned h,
						  bool fAutoSelectColor = true);
...
typedef struct LodePNGColorMode
{
  ...
  */
  ...
  lodepng_size_t palettesize; /*palette size in number of colors (amount of bytes is 4 * palettesize)*/
...
typedef struct LodePNGInfo
{
  ...
  For grayscale PNGs, r, g and b will all 3 be set to the same. When encoding
  ...
  */
  lodepng_size_t text_num; /*the amount of texts in these char** buffers (there may be more texts in itext)*/
  ...
  */
  lodepng_size_t itext_num; /*the amount of international texts in this PNG*/
  ...
  */
  ...
  lodepng_size_t unknown_chunks_size[3]; /*size in bytes of the unknown chunks, given for protection*/
#endif /*LODEPNG_COMPILE_ANCILLARY_CHUNKS*/
} LodePNGInfo;
...
typedef enum LodePNGAutoConvert
{
  ...
  LAC_ALPHA, /*use color type user requested, but if only opaque pixels and RGBA or gray+alpha, use RGB or gray*/
...
*/
unsigned lodepng_zlib_decompress(unsigned char** out, lodepng_size_t* outsize,
                                 const unsigned char* in, lodepng_size_t insize,
                                 const LodePNGDecompressSettings* settings);
#endif /*LODEPNG_COMPILE_DECODER*/
...
buffer and *outsize its size in bytes. out must be freed by user after usage.
*/
unsigned lodepng_zlib_compress(unsigned char** out, lodepng_size_t* outsize,
                               const unsigned char* in, lodepng_size_t insize,
...
*) 24 jan 2007: gave encoder an error interface. Added color conversion from any
    grayscale type to 8-bit grayscale with or without alpha.
